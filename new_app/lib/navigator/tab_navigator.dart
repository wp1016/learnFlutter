...
import 'package:new_app/pages/my/my.dart';
import 'package:new_app/pages/search/search.dart';
import 'package:new_app/pages/travel/travel.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: PageView(
        ...
        children: <Widget>[HomePage(), MyCenter(), SearchPage(), TravelPage()],
      ),
